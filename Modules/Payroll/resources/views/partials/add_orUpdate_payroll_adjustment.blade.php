...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasPayrollAdjustment"
  ...
  <div class="offcanvas-header border-bottom">
    <h5 id="offcanvasPayrollAdjustmentLabel" class="offcanvas-title">@lang('Manage Payroll Adjustment')</h5>
    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
  </div>
  <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
    <form action="{{ route('employees.addOrUpdatePayrollAdjustment') }}" method="POST">
      @csrf
      ...
      <!-- Adjustment Name -->
      <div class="mb-4">
        <label class="form-label" for="adjustmentName">@lang('Adjustment Name')</label>
      ...
      <div class="mb-4">
        ...
        <select name="adjustmentType" id="adjustmentType" class="form-select">
          <option value="benefit" selected>@lang('Benefit')</option>
      ...
      <div class="mb-4 d-none">
        ...
        <input type="number" step="0.01" name="adjustmentPercentage" id="adjustmentPercentage"
               class="form-control" placeholder="Enter adjustment percentage (Optional)"/>
      </div>

  ...
  const fv = FormValidation.formValidation(addLeaveTypeForm, {
    fields: {
      ...
      per_month: {
        validators: {
          integer: {
            message: 'Max Leaves Per Month must be an integer'
          },
          min: {
            min: 0,
            message: 'Max Leaves Per Month cannot be negative'
          }
        }
      },
      per_year: {
        validators: {
          integer: {
            message: 'Max Leaves Per Year must be an integer'
          },
          min: {
            min: 0,
            message: 'Max Leaves Per Year cannot be negative'
          }
        }
      }
    },
